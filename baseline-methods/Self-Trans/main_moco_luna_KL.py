...
parser.add_argument('--resume', default='save_model_dense/checkpoint_luna_covid_moco_backup.pth.tar', type=str,
                    metavar='PATH',
...
writer = SummaryWriter('./loss_luna')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if not args.multiprocessing_distributed or (args.multiprocessing_distributed
            ...
            }, is_best=False, filename='save_model_dense1/checkpoint_luna_KL+++.tar'.format(epoch))
...
def train(train_loader, model, criterion, criterion1, optimizer, epoch, args):
    ...
    for i, (images, _) in enumerate(train_loader):
        ...
        if i % args.print_freq == 0:
            progress.display(i)
        writer.add_scalar("loss/luna", loss, epoch)

...
parser.add_argument('--resume', default='save_model_dense/checkpoint_luna_1e-2.tar', type=str, metavar='PATH',
...
#     normalize = transforms.Normalize(mean=[0.6310, 0.6306, 0.6305], std=[0.3059, 0.3060, 0.3059])
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if not args.multiprocessing_distributed or (args.multiprocessing_distributed
            ...
            }, is_best=False, filename='save_model_dense/checkpoint_luna_covid_1e-2.tar'.format(epoch))
...
def save_checkpoint(state, is_best, filename='save_model_dense/checkpoint.pth.tar'):
    torch.save(state, filename)
    if is_best:
        shutil.copyfile(filename, 'save_model_dense/model_best.pth.tar')
